...
namespace AssetBundles
{
    internal class LaunchAssetBundleServer : ScriptableSingleton<LaunchAssetBundleServer>
    {
        ...
        static void Run()
        {
            string pathToAssetServer = Path.GetFullPath("Assets/Scripts/Utility/AssetBundleManager/Editor/AssetBundleServer.exe");
            ...
            string monoInstallation = MonoInstallationFinder.GetMonoInstallation("MonoBleedingEdge");
            string monoProfileVersion = GetMonoProfileVersion();
            ProcessStartInfo startInfo = ExecuteInternalMono.GetProfileStartInfoForMono(monoInstallation, monoProfileVersion, pathToAssetServer, args, true);
        ...
        static string GetMonoProfileVersion()
        {
            ...
            Version profileVersion = Version.Parse("1.0");
            ...
            for (int i = 0; i < foldersWithApi.Length; i++)
            {
                ...
                Version version = Version.Parse(foldersWithApi[i]);
