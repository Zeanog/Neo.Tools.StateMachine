...
namespace AssetBundles
{
    ...
    {
        const string kDevelopmentMode = "Assets/AssetBundles/DevelopmentMode";

        [MenuItem(kDevelopmentMode)]
        public static void ToggleSimulationMode()
        {
            Neo.AssetBundleManager.Instance.DevelopmentMode = !Neo.AssetBundleManager.Instance.DevelopmentMode;
        }

        [MenuItem(kDevelopmentMode, true)]
        public static bool ToggleSimulationModeValidate()
        {
            Menu.SetChecked(kDevelopmentMode, Neo.AssetBundleManager.Instance.DevelopmentMode);
            return true;
        }
